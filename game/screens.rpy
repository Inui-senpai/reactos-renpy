...
style scrollbar:
    ...
    base_bar Frame("gui/scrollbar/horizontal_[prefix_]bar.png", gui.scrollbar_borders, tile=True)
    thumb Frame("gui/scrollbar/horizontal_[prefix_]thumb.png", gui.scrollbar_borders, tile=gui.scrollbar_tile)
    unscrollable "hide"

style vscrollbar:
    xsize gui.scrollbar_size
    base_bar Frame("gui/scrollbar/vertical_[prefix_]bar.png", gui.vscrollbar_borders, tile=True)
...
# Привязки к стандартным стилям для заимствования их основных свойств
style ros_check_label is check_label
style ros_check_label_text is check_label_text:
    font "gui/font/tahoma.ttf"
    size 11
    color "#000"
    hover_color "#000"
style ros_check_button is check_button:
    foreground "gui/window/common/check_[prefix_]foreground.png"
style ros_check_button_text is check_button_text:
    font "gui/font/tahoma.ttf"
    size 11
    color "#000"
    hover_color "#000"
...
style ros_radio_label is radio_label
style ros_radio_label_text is radio_label_text:
    font "gui/font/tahoma.ttf"
    size 11
    color "#000"
    hover_color "#000"
style ros_radio_button is radio_button:
    foreground "gui/window/common/radio_[prefix_]foreground.png"
style ros_radio_button_text is radio_button_text:
    font "gui/font/tahoma.ttf"
    size 11
    color "#000"
    hover_color "#000"
...
screen confirm(message, yes_action, no_action, level=None):
        ...
        frame:
            ...
            vbox:
                ...
                hbox:
                    ...
                    textbutton _("Да") style "ros_confirm_button" text_style "ros_confirm_button_text" action yes_action
                    textbutton _("Нет") style "ros_confirm_button" text_style "ros_confirm_button_text" action no_action
...
screen dialog(message, ok_action, level=None):
        ...
        frame:
            ...
            vbox:
                ...
                hbox:
                    ...
                    textbutton _("ОК") style "ros_confirm_button" text_style "ros_confirm_button_text" action ok_action
...
# Привязки к стандартным стилям для заимствования их основных свойств
style ros_confirm_prompt is confirm_prompt
style ros_confirm_prompt_text is confirm_prompt_text
style ros_confirm_button is confirm_button
style ros_confirm_button_text is confirm_button_text
style ros_installed_confirm_frame is confirm_frame:
    background Frame("gui/window/common/window.png", gui.confirm_frame_borders, tile=gui.frame_tile)
style ros_confirm_prompt_installed is confirm_prompt
style ros_confirm_prompt_installed_text is confirm_prompt_text:
    font "gui/font/tahoma.ttf"
    size 11
    color "#000"
    ypos -8
style ros_confirm_button_installed is confirm_button:
    idle_background "gui/window/postinstall/button_idle.png"
    hover_background "gui/window/postinstall/button_hover.png"
style ros_confirm_button_installed_text is confirm_button_text:
    font "gui/font/tahoma.ttf"
    color "#000"
    hover_color "#000"
    size 11
    xpos 36
style ros_confirm_button_installed_no is ros_confirm_button_installed_text:
    xpos 39
...
# Стиль текста в плашке
style ros_confirm_prompt_text:
...
# Стиль кнопок "ОК" и "Да"/"Нет" в плашке
style ros_confirm_button:
    background "#0000c3"
    hover_background "#c3c3c3"
    xsize 40
    ysize 23
style ros_confirm_button_text:
    font "gui/font/UniVGA16.ttf"
    color "#c3c3c3"
    hover_color "#000"
