...
define config.version = "0.4.15-x86-dev"
...
define gui.about = _p("""
Оригинальная ОС: ReactOS Team; оф. сайт: {a=https://reactos.org}https://reactos.org{/a}, страница проекта на GitHub: {a=https://github.com/reactos/reactos}https://github.com/reactos/reactos{/a}

Портирование на Ren'Py: MtnDewSmoker420, специально для RG Smoking Room; страница фан-группы в ВКонтакте: {a=https://vk.com/onthecrack}https://vk.com/onthecrack{/a}

Материал, включённый в данный проект, используется согласно условиям добровольного использования. Права на весь использованный материал принадлежат их создателям.
""")
...
define build.name = "reactos_test"
...
define config.save_directory = "reactos_test-1620630134"
