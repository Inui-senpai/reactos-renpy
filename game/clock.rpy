# original by trooper6, https://lemmasoft.renai.us/forums/viewtopic.php?f=51&t=21978
...
init -1 python:
    ...
    """As a Creator Defined Displayable this needs to extend the Displayable class)"""
    class Clock(renpy.Displayable):
        ...
        def __init__(self, ana=True, h=0, m=0, resize=150, sH=True, mil_time=False, **kwargs):
            ...
            # self.digital_base_image = im.Scale("gui/DigitalClockBase_None.png", 
            ...
            # self.play_chime = False #Chimes are currently running or not
            # self.alarm_on = False
        ...
        def render(self, width, height, st, at):
            ...
            #     self.d_height)) 
            digi = Fixed(digi_text, xysize=(self.width, self.d_height)) 
        ...
        # def visit(self):
        #     return [self.digital_base_image]
